...
@section('content')
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		...
		@can('faq-create')
			<a class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" href="{{ route('faq.create') }}"><i class="fas fa-plus fa-sm text-white-50"></i> Добавить FAQ</a>
		@endcan
	</div>
			...
			<tbody>
				@foreach ($faqs as $obj)
                    <tr>
                        ...
                        <td>
                        	@can('faq-edit')
                            	<a href="{{route('faq.edit',['faq'=>$obj->id])}}" class="btn btn-primary btn-sm">Edit</a>&nbsp;&nbsp;&nbsp;
                            @endcan
                            @can('faq-delete')
