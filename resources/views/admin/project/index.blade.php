...
@section('content')
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		...
		@can('project-create')
			<a class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" href="{{ route('project.create') }}"><i class="fas fa-plus fa-sm text-white-50"></i> New project</a>
		@endcan
	</div>
			...
			<tbody>
				@foreach ($projects as $obj)
                    <tr>
                        ...
                        <td>
                        	@can('project-edit')
                            	<a href="{{route('project.edit',['project'=>$obj->id])}}" class="btn btn-primary btn-sm">Edit</a>&nbsp;&nbsp;&nbsp;
                            @endcan
                            @can('project-delete')
